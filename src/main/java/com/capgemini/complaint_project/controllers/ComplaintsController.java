...
public class ComplaintsController {
	...
	@GetMapping("/complaintDesciption/{id}")
	public ResponseEntity<Complaint> getComplaintsByDescription(@PathVariable Long id){
		return ResponseEntity.status(HttpStatus.OK).body(complaintService.findDescriptionById(id));
	}
